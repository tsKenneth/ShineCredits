...
function Plugin:Initialise()
    ...
    -- Add Credits Menu to main vote menu =====================================
...
if Client then
    -- Credits Menu, will run whenenver credits menu is opened ================
    ...
    function Plugin:ReceiveGUINotify( Data )
        CreditsMenu:ReceiveGUINotify( Data )
    end
